...
class ArSingleShotRecommendationSystem:
    ...
    def handle_user_message(self, message):
        ...
        if course_name:
            ...
            return f" فى البداية حابة اقولك ان المادة بسيطة خالص ولا تقلق من نظام الامتحان ابدا \n \nاما بالنسبة لنظام الامتحان الخاص بالمقرر{course_name}\n{exam_data}", []
            ...
            return f" فى البداية حابة اقولك متقلقش خالص هذا الدكتور اسلوبه سهل وامتحانه غير مستحيل النجاح فيه\n\n اما بالنسبة لنظام الامتحان الخاص بالدكتور {professor_name}\n{exam_data}", []
